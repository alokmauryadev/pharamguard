...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-slate-50 overflow-hidden font-sans selection:bg-teal-100 selection:text-teal-900">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/70 border-b border-slate-200/50 transition-all duration-300">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 pb-24 lg:pt-48 relative z-10">
        ...
        <div className="text-center max-w-5xl mx-auto mb-32">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 border border-slate-200 shadow-sm backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-slate-900 mb-8 leading-[1.05] animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-200">
            ...
            <button className="px-8 py-4 text-lg font-bold text-slate-700 bg-white border border-slate-200 rounded-full hover:bg-slate-50 transition-all duration-300 hover:shadow-lg">
              View Sample Report
            </button>
          </div>
        </div>
        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <GlassCard key={i} className={`p-8 hover:-translate-y-2 duration-500 ${feature.delay} border border-slate-200/50`}>
              <div className={`w-14 h-14 rounded-2xl ${feature.bg} flex items-center justify-center mb-6 ${feature.color} ring-4 ring-white shadow-sm`}>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
            ...
            <span className="font-bold text-slate-900">PharmaGuard</span>
          </div>
